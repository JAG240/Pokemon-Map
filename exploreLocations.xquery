(: 2019-04-01 ebb: I wrote this to explore the location elements in the Pokemon collection to see how data is stored. I determined that there are two ways, through a <landmark> and a <route> element.  :)
